    ...
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {/* Gráfico de frequência de sessões — largura cheia para respirar tanto no desktop quanto no mobile */}
          ...
          {/* Atividade recente + aniversariantes lado a lado no desktop, empilhados no mobile */}
          <div className={`grid grid-cols-1 ${aniversariantes.length > 0 ? 'lg:grid-cols-2' : ''} gap-4`}>

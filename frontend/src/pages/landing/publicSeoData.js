...
export const PAGES = {
  ...
  faq: {
    ...
    faqs: [
      ...
      { q: 'O CoachPilot tem plugin do ChatGPT?', a: 'Sim. O CoachPilot é um app publicado no diretório do ChatGPT: abra Plugins, busque por "coachpilot", clique no + e autorize com a sua conta. Por baixo é um servidor MCP, então a mesma conexão funciona no Claude e no Gemini.' },
      { q: 'Como conecto minha IA ao CoachPilot?', a: 'No ChatGPT, instalando o app pelo diretório (Plugins → buscar "coachpilot" → +). No Claude ou no Gemini, copiando o endereço do servidor MCP em Configurações → Conexões e adicionando no assistente. A autorização é por OAuth, com escolha entre somente leitura ou leitura e escrita de treinos.' },

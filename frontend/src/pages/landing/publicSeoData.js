...
export const PAGES = {
  'software-personal-trainer': {
    ...
    sections: [
      ...
      { title: 'Conexão MCP: a sua IA falando com o sistema', body: 'O CoachPilot tem conexão MCP, o padrão que ChatGPT, Claude e Gemini usam para conversar com sistemas de fora. Autorizada uma vez, a sua IA consulta alunos, anamneses, avaliações, sessões, evolução e agenda, e — se você permitir — monta e aplica programas de treino direto na plataforma, com aviso e desfazer. Gratuito nos dois planos.' },

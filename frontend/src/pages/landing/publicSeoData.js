...
export const PAGES = {
  ...
  'chatgpt-personal-trainer': {
    ...
    description: 'Instale o app do CoachPilot no ChatGPT e gerencie alunos e treinos conversando: consulte a carteira, prepare a sessão e aplique programas sem abrir o portal. Também funciona com Claude e Gemini.',
    h1: 'ChatGPT para personal trainer conectado aos seus alunos de verdade',
    intro: 'O CoachPilot é um app publicado no diretório do ChatGPT: você abre Plugins, busca por CoachPilot, clica no + e entra com a sua conta para autorizar. A partir daí passa a perguntar sobre a sua carteira em português, recebendo resposta do dado real: quem está parado, o que a Júlia respondeu na anamnese, como está a evolução do agachamento da Carla. Por baixo é o padrão aberto MCP, então a mesma conexão vale para Claude e Gemini.',
    bullets: ['App no diretório do ChatGPT, instalado em 3 cliques', 'Funciona também na conta gratuita do ChatGPT', 'Monte e aplique programas de treino pelo chat', 'Autorização feita por você, revogável a qualquer momento'],
    sections: [
      { title: 'Como instalar e autorizar', body: 'No ChatGPT: [abra o app do CoachPilot](https://chatgpt.com/plugins/plugin_asdk_app_6a80cc8edfb48191b895cbaecd19b642) e clique no + para adicionar — ou busque por "coachpilot" no menu Plugins. A tela do CoachPilot abre em seguida para você fazer login, ver o que aquela IA vai poder fazer e escolher entre somente leitura ou leitura e escrita de treinos — sua senha nunca passa pelo ChatGPT. Para Claude e Gemini o caminho é outro: em Configurações → Conexões você copia o endereço da conexão e adiciona no assistente (no Claude o conector funciona até no plano grátis, limitado a um; no Gemini o caminho suportado hoje é CLI ou Vertex).' },
      ...
      { title: 'Os limites, de propósito', body: 'A IA faz apenas o que você autorizou. Não existe excluir aluno, apagar histórico, mexer em plano, assinatura ou cobrança, nem alteração em massa: cada programa é aplicado a um aluno por vez, para que o desfazer também seja individual. E nenhuma conexão vê dado de outro personal — cada autorização alcança somente a sua conta.' },
    ...
    faqs: [
      { q: 'Existe plugin do ChatGPT para personal trainer?', a: 'Sim: o CoachPilot está publicado no diretório de apps do ChatGPT. Basta abrir Plugins, buscar por "coachpilot", clicar no + e autorizar com a sua conta. Por baixo a tecnologia é MCP (Model Context Protocol), então a mesma conexão funciona também no Claude e no Gemini.' },
      ...
      { q: 'Preciso de ChatGPT Plus?', a: 'Não. O app do CoachPilot está no diretório público do ChatGPT e funciona também na conta gratuita. No Claude, o conector personalizado também funciona no plano grátis, com o limite de um conector.' },

...
export const PAGES = {
  'software-personal-trainer': {
    ...
    sections: [
      ...
      { title: 'Conexão MCP: a sua IA falando com o sistema', body: 'O CoachPilot tem conexão MCP, o padrão que ChatGPT, Claude e Gemini usam para conversar com sistemas de fora. Autorizada uma vez, a sua IA consulta alunos, anamneses, avaliações, sessões, evolução e agenda, e — se você permitir — monta e aplica programas de treino direto na plataforma, com aviso e desfazer. Gratuito nos dois planos. No ChatGPT, [o app instala por este link](https://chatgpt.com/plugins/plugin_asdk_app_6a80cc8edfb48191b895cbaecd19b642).' },
    ...
    faqs: [
      ...
      { q: 'Dá para usar o software pelo ChatGPT?', a: 'Sim. Pela conexão MCP do CoachPilot, o ChatGPT, o Claude ou o Gemini consultam os seus alunos e treinos e podem aplicar programas, conversando — sem abrir o portal. É gratuito nos dois planos.' },
    ],
  ...
  'ia-personal-trainer': {
    ...
    intro: 'O CoachPilot tem conexão MCP: você conecta a IA que já assina — ChatGPT, Claude ou Gemini — e ela passa a ler os seus alunos, anamneses, avaliações, histórico de sessões e evolução, além de montar e aplicar programas de treino direto na plataforma. Sem copiar, sem colar, sem baixar arquivo. A conexão é gratuita nos dois planos, inclusive no grátis.',
    bullets: ['Conexão com ChatGPT, Claude ou Gemini, gratuita nos dois planos', 'A IA responde com o seu dado real, não com estimativa', 'Escrita de treino com aviso no portal e desfazer por 7 dias', 'Você escolhe se a IA só consulta ou também altera treinos'],
    sections: [
      { title: 'Como começar hoje', body: 'Se a sua IA é o ChatGPT, [instale o app do CoachPilot](https://chatgpt.com/plugins/plugin_asdk_app_6a80cc8edfb48191b895cbaecd19b642), clique no + e autorize com a sua conta — funciona na conta gratuita do ChatGPT e no aplicativo de celular. Para Claude ou Gemini, o endereço da conexão fica em Configurações → Conexões, no portal. Vale começar autorizando somente leitura e liberar a escrita de treinos depois.' },
      ...
      { title: 'Sem custo de IA na mensalidade', body: 'O custo do modelo é da sua assinatura de ChatGPT, Claude ou Gemini e não passa pelo CoachPilot. Isso muda duas coisas: você não paga IA embutida em plano que talvez não use, e não fica preso ao modelo de um fornecedor — usa o que preferir e troca quando quiser.' },
      { title: 'Prescrição continua sendo sua', body: 'A IA produz e digita; a decisão técnica é do personal, sob responsabilidade profissional e registro no CREF. A revisão acontece na conversa, antes de aplicar, e toda escrita gera notificação no portal e pode ser desfeita por 7 dias. A IA não exclui aluno, não apaga histórico e não mexe em plano e cobrança.' },
      ...
      { title: 'Comparativo: quem está em qual nível', body: 'Se você está avaliando plataformas por esse critério, o comparativo de IA por plataforma — MFIT, Tecnofit, TreinoAI, Nexur e CoachPilot — está em [melhores apps para personal trainer com IA em 2026](/blog/melhores-apps-personal-trainer-com-ia). Os comandos práticos do dia a dia estão em [como usar IA para gerenciar alunos](/blog/ia-para-gerenciar-alunos-personal-trainer), e a explicação técnica do padrão de conexão em [MCP para personal trainer](/blog/mcp-para-personal-trainer).' },
    ],
    faqs: [
      { q: 'Existe app para personal trainer com IA?', a: 'Sim. O CoachPilot conecta o ChatGPT, o Claude ou o Gemini aos seus dados por MCP — no ChatGPT, pelo plugin publicado no Diretório de Plugins — e também oferece prompts prontos para gerar treinos e migrar a carteira sem conexão. Os dois recursos são gratuitos nos dois planos.' },
      { q: 'Qual o melhor app para personal trainer com IA?', a: 'Depende do nível de IA que você precisa: gerador de treino dentro do app, ou IA conectada aos dados reais dos alunos. O comparativo plataforma por plataforma, com data de verificação, está no artigo melhores apps para personal trainer com IA em 2026.' },
      ...
      { q: 'A IA pode alterar meus treinos sem eu ver?', a: 'Você escolhe, na autorização, se a conexão é só de leitura ou também de escrita. Com escrita ativa, toda alteração gera notificação no portal e pode ser desfeita por 7 dias.' },
    ...
    related: ['chatgpt-personal-trainer', 'integracao-chatgpt', 'software-personal-trainer', 'precos'],
  },
  'chatgpt-personal-trainer': {
    path: '/chatgpt-para-personal-trainer',
    title: 'ChatGPT para Personal Trainer: o plugin CoachPilot | CoachPilot',
    description: 'O CoachPilot é um plugin para personal trainers no Diretório de Plugins do ChatGPT. Instale em três cliques e gerencie alunos e treinos conversando: consulte a carteira, prepare a sessão e aplique programas sem abrir o portal.',
    h1: 'ChatGPT para personal trainer conectado aos seus alunos de verdade',
    intro: 'Sim, é possível gerenciar alunos e treinos pelo ChatGPT. O CoachPilot é um plugin para personal trainers publicado no Diretório de Plugins do ChatGPT: ele inclui um app que conecta a conversa aos dados e ações autorizadas da sua conta CoachPilot. Você busca por "coachpilot" no diretório, clica no + e entra com a sua conta para autorizar. A partir daí pergunta sobre a sua carteira em português e recebe resposta do dado real: quem está parado, o que a Júlia respondeu na anamnese, como está a evolução do agachamento da Carla. Por baixo é o padrão aberto MCP, então a mesma conexão vale para Claude e Gemini.',
    bullets: ['Plugin no Diretório de Plugins do ChatGPT, instalado em 3 cliques', 'Funciona também na conta gratuita do ChatGPT', 'Monte e aplique programas de treino pelo chat', 'Autorização feita por você, revogável a qualquer momento'],
    sections: [
      { title: 'Abrir o CoachPilot no ChatGPT', body: '[Abrir o plugin CoachPilot no ChatGPT](https://chatgpt.com/plugins/plugin_asdk_app_6a80cc8edfb48191b895cbaecd19b642) — se você já está logado, o link abre a ficha do plugin e basta clicar no +. Se preferir o caminho manual: menu lateral do ChatGPT → Plugins → buscar por "coachpilot". Você também precisa de uma conta CoachPilot, e o [plano grátis de até 3 alunos](/precos) serve para testar o fluxo inteiro.' },
      {
        title: 'Passo a passo da instalação',
        body: 'Leva menos de um minuto, e o Diretório de Plugins está disponível em todos os planos do ChatGPT, inclusive o gratuito (verificado em setembro de 2026).',
        list: [
          'Abra o Diretório de Plugins no menu lateral do ChatGPT.',
          'Busque por "coachpilot" — o plugin aparece na lista pública.',
          'Clique no + para adicionar. O plugin entra na sua conta na hora.',
          'A tela do CoachPilot abre para você fazer login — sua senha nunca passa pelo ChatGPT.',
          'Escolha as permissões: somente leitura, ou leitura e escrita de treinos.',
          'Volte à conversa e teste com algo que você sabe de cor: "lista meus alunos ativos".',
        ],
      },
      {
        title: 'Exemplos de comandos que funcionam no primeiro dia',
        body: 'Tudo em português corrido — não existe sintaxe a decorar. Os cinco primeiros funcionam com permissão de leitura; os dois últimos exigem escrita autorizada.',
        list: [
          '"Quem não treina há mais de 10 dias?"',
          '"Me dá o resumo da Júlia antes da sessão de amanhã."',
          '"Como está a evolução do agachamento da Carla nos últimos 3 meses?"',
          '"Quem está sem programa vigente ou com mensalidade em atraso?"',
          '"O que eu tenho na agenda de quinta?"',
          '"Adapta o treino do Pedro pra dor no ombro e aplica."',
          '"Desfaz a última alteração que você fez."',
        ],
      },
      { title: 'As permissões que você concede', body: 'Na tela de autorização você escolhe entre somente leitura e leitura com escrita de treinos, e a escolha vale por conexão — dá para começar só lendo e liberar a escrita depois. A leitura alcança alunos, anamnese, avaliações, sessões, evolução por exercício, agenda e pendências. A escrita alcança apenas programa de treino: aplicar, atualizar e desfazer. Detalhamento completo em [ChatGPT e dados de alunos](/blog/chatgpt-dados-alunos-personal-trainer-seguranca).' },
      { title: 'Sem copiar e colar', body: 'O fluxo antigo era baixar o programa, colar na IA, pedir o ajuste e reimportar. O plugin elimina os quatro passos: a IA lê e grava pelo mesmo caminho de código do portal, com as mesmas validações. Um programa com erro de estrutura é recusado antes de gravar, com a explicação do que corrigir.' },
      { title: 'Os limites, de propósito', body: 'A IA faz apenas o que você autorizou. Não existe excluir aluno, apagar histórico, mexer em plano, assinatura ou cobrança, nem alteração em massa: cada programa é aplicado a um aluno por vez, para que o desfazer também seja individual. Toda escrita avisa você no portal e pode ser desfeita por 7 dias. E nenhuma conexão vê dado de outro personal — cada autorização alcança somente a sua conta.' },
      { title: 'Claude e Gemini pelo mesmo caminho', body: 'O padrão de conexão é aberto (MCP), então quem prefere outra IA chega ao mesmo lugar. Em Configurações → Conexões, no portal, você copia o endereço da conexão e adiciona no assistente: no Claude o conector personalizado funciona até no plano grátis, limitado a um; no Gemini o caminho suportado hoje é CLI ou Vertex. Comparativo em [Claude, ChatGPT ou Gemini para personal trainer](/blog/claude-chatgpt-ou-gemini-para-personal-trainer).' },
      { title: 'Dado de saúde: o que você precisa saber', body: 'A consulta alcança anamnese, avaliações físicas e relatos de dor — dados sensíveis de saúde do aluno pela LGPD. Consultá-los por uma IA externa envia a informação ao provedor daquela IA, no exterior. É a sua decisão e exige que o consentimento obtido do aluno cubra essa transferência; quem não quer essa transmissão não conecta. A hipótese está descrita nos [termos de uso](/termos) e na [política de privacidade](/privacidade).' },
      { title: 'Continuar lendo', body: 'O passo a passo com telas está em [como instalar o CoachPilot no ChatGPT](/blog/como-instalar-coachpilot-no-chatgpt). O artigo técnico completo sobre o plugin está em [app de personal trainer dentro do ChatGPT](/blog/app-de-personal-trainer-para-chatgpt). A lista do que dá para pedir está em [gerenciar alunos e treinos pelo ChatGPT](/blog/gerenciar-alunos-e-treinos-pelo-chatgpt), e o comparativo de plataformas em [melhores apps para personal trainer com IA](/blog/melhores-apps-personal-trainer-com-ia). A ficha técnica canônica da integração fica em [documentação da integração com o ChatGPT](/integracoes/chatgpt).' },
    ],
    faqs: [
      { q: 'Existe plugin do ChatGPT para personal trainer?', a: 'Sim: o CoachPilot é um plugin para personal trainers publicado no Diretório de Plugins do ChatGPT. Basta abrir Plugins, buscar por "coachpilot", clicar no + e autorizar com a sua conta. Por baixo a tecnologia é MCP (Model Context Protocol), então a mesma conexão funciona também no Claude e no Gemini.' },
      { q: 'Chama plugin ou app?', a: 'Os dois, e nenhum está errado. Em julho de 2026 a OpenAI migrou o diretório de apps para o Diretório de Plugins, empacotando os apps existentes em plugins: o plugin é o que você instala pelo diretório, e o app é a integração que conecta o ChatGPT a dados e ações externas. O plugin CoachPilot inclui o app que conversa com a sua conta.' },
      { q: 'Dá para gerenciar alunos pelo ChatGPT?', a: 'Sim. Com o plugin instalado, você consulta alunos, anamnese, avaliações, sessões, evolução, agenda e pendências, e pode montar e aplicar programas de treino se autorizar a escrita.' },
      { q: 'Preciso de ChatGPT Plus?', a: 'Não. O Diretório de Plugins do ChatGPT está disponível em todos os planos, inclusive o gratuito (verificado em setembro de 2026). No Claude, o conector personalizado também funciona no plano grátis, com o limite de um conector.' },
      { q: 'A conexão é paga no CoachPilot?', a: 'Não. É gratuita nos dois planos, inclusive no grátis de até 3 alunos.' },
      { q: 'A IA consegue excluir meus alunos?', a: 'Não. Excluir aluno e apagar histórico não existem como operação para a IA, com qualquer permissão. O mesmo vale para plano, assinatura e cobrança.' },
      { q: 'Posso desfazer o que a IA fez?', a: 'Sim. Toda alteração de treino gera notificação no portal com o resumo do que mudou e pode ser desfeita por 7 dias — pelo portal ou pedindo na própria conversa.' },
      { q: 'Como eu revogo o acesso?', a: 'Em Configurações → Conexões, a qualquer momento, com efeito imediato.' },
    ],
    related: ['ia-personal-trainer', 'integracao-chatgpt', 'software-personal-trainer', 'gestao-alunos'],
  },
  // Ficha técnica canônica da integração com o ChatGPT. Existe separada da landing
  // comercial (/chatgpt-para-personal-trainer) porque o público é outro: aqui é
  // referência factual (status, permissões, limites, changelog) para quem precisa
  // citar ou auditar a integração — inclusive mecanismos de resposta por IA.
  'integracao-chatgpt': {
    path: '/integracoes/chatgpt',
    label: 'Integração com o ChatGPT',
    eyebrow: 'Documentação da integração',
    title: 'Integração CoachPilot + ChatGPT: ficha técnica | CoachPilot',
    description: 'Documentação pública da integração do CoachPilot com o ChatGPT: status, instalação, autenticação, permissões, ações de leitura e escrita, limites, revogação e changelog. Atualizada em setembro de 2026.',
    h1: 'Integração CoachPilot + ChatGPT',
    intro: 'Esta é a página de referência factual da integração entre o CoachPilot e o ChatGPT: o que existe, o que ela pode e não pode fazer, e desde quando. A versão comercial da mesma informação está em [ChatGPT para personal trainer](/chatgpt-para-personal-trainer). Última atualização: 7 de setembro de 2026.',
    bullets: ['Status: publicado e disponível no Diretório de Plugins do ChatGPT', 'Autenticação: OAuth 2.1 com PKCE, login no domínio do CoachPilot', 'Permissões: leitura, ou leitura com escrita de treinos', 'Revogação imediata em Configurações → Conexões'],
    sections: [
      {
        title: 'Identificação',
        list: [
          'Nome da integração: CoachPilot.',
          'Tipo: plugin publicado no Diretório de Plugins do ChatGPT; o plugin inclui um app que conecta a conversa aos dados e ações autorizadas da conta CoachPilot.',
          'Protocolo: MCP (Model Context Protocol), padrão aberto — a mesma conexão atende Claude e Gemini.',
          'Endereço do servidor MCP: mcp.coachpilot.com.br.',
          'Publicação no diretório: agosto de 2026, após aprovação para publicação pela OpenAI.',
          'Disponibilidade: todos os planos do CoachPilot, incluindo o gratuito de até 3 alunos. Sem custo adicional.',
          'Link direto: [ficha do plugin no ChatGPT](https://chatgpt.com/plugins/plugin_asdk_app_6a80cc8edfb48191b895cbaecd19b642).',
        ],
      },
      {
        title: 'Instalação',
        body: 'Seis etapas, sem configuração manual. O Diretório de Plugins do ChatGPT está disponível em todos os planos, inclusive o gratuito (verificado em setembro de 2026).',
        list: [
          'Abrir o Diretório de Plugins no menu lateral do ChatGPT.',
          'Buscar por "coachpilot".',
          'Clicar no + para adicionar o plugin à conta.',
          'Fazer login na tela do CoachPilot que abre em seguida.',
          'Escolher o escopo de permissão (leitura, ou leitura e escrita de treinos).',
          'Confirmar. A conexão passa a valer na conversa imediatamente.',
        ],
      },
      {
        title: 'Autenticação',
        body: 'OAuth 2.1 com PKCE (S256) e registro dinâmico de cliente. O login e a tela de consentimento acontecem no domínio do CoachPilot: o ChatGPT nunca recebe a senha do personal, apenas um token com o escopo concedido. O código de autorização é de uso único e o refresh token é rotativo. O token é vinculado à conta que autorizou — o identificador do personal vem do token, nunca de um argumento preenchido pelo modelo, de modo que texto escrito por aluno não consegue redirecionar o acesso para outra conta.',
      },
      {
        title: 'Ações de leitura',
        body: 'Disponíveis com qualquer permissão concedida. Todas restritas à conta que autorizou.',
        list: [
          'Listar alunos, com status e data do último treino.',
          'Detalhar um aluno: anamnese, metas, avaliações físicas, sessões recentes, dores relatadas e notas.',
          'Evolução por exercício, com carga e volume ao longo do tempo.',
          'Resumo da carteira: quem está parado, sem programa vigente ou com mensalidade em atraso.',
          'Agenda de um período.',
          'Histórico de sessões de um aluno.',
          'Biblioteca de exercícios da conta, com os vídeos cadastrados pelo personal.',
          'Guia de prescrição: regras e formato de programa da plataforma.',
          'Exportar e validar um programa de treino sem gravar.',
        ],
      },
      {
        title: 'Ações de escrita',
        body: 'Disponíveis apenas se o personal concedeu a permissão de escrita de treinos. Alcançam exclusivamente programa de treino.',
        list: [
          'Aplicar programa de treino a um aluno (substitui o programa vigente daquele aluno).',
          'Atualizar um treino específico.',
          'Desfazer a última alteração de treino.',
        ],
      },
      {
        title: 'Limites — o que a integração não faz',
        body: 'Estes limites não são configuráveis, nem pelo personal nem pela IA. Eles não dependem da permissão concedida.',
        list: [
          'Não exclui aluno e não apaga histórico. A operação não existe.',
          'Não altera plano, assinatura, cobrança ou qualquer dado financeiro.',
          'Não faz escrita em massa: cada programa é aplicado a um aluno por vez, para que o desfazer também seja individual.',
          'Não alcança dados de outro personal: cada autorização vale apenas para a conta que a concedeu.',
          'Não grava programa com erro semântico: a validação roda antes da gravação e recusa o programa explicando o que corrigir.',
          'Não substitui a decisão do profissional: restrições de anamnese e dores relatadas são invioláveis, e a prescrição permanece ato do personal com registro no CREF.',
        ],
      },
      {
        title: 'Garantias operacionais da escrita',
        list: [
          'Snapshot antes de cada alteração, que é a base do desfazer.',
          'Desfazer disponível por 7 dias, pelo portal ou pela própria conversa.',
          'Notificação no portal a cada alteração, com o resumo do que mudou.',
          'Idempotência por chave: pedido repetido não duplica a gravação.',
          'Registro de auditoria de toda escrita.',
        ],
      },
      {
        title: 'Revogação',
        body: 'Em Configurações → Conexões, no portal do CoachPilot, a qualquer momento e com efeito imediato. A revogação encerra o acesso daquela conexão sem afetar as demais nem os dados já gravados. Também é possível remover o plugin pelo próprio ChatGPT.',
      },
      {
        title: 'Dado de saúde e LGPD',
        body: 'A leitura alcança anamnese, avaliações físicas e relatos de dor — dados pessoais sensíveis de saúde na definição da LGPD. Consultá-los por meio de uma IA externa envia a informação ao provedor daquela IA, no exterior, o que configura transferência internacional de dado sensível e exige consentimento específico do aluno para essa finalidade. A hipótese está descrita nos [termos de uso](/termos) e na [política de privacidade](/privacidade). Conectar é decisão do personal: quem não quer essa transmissão simplesmente não conecta e segue usando o portal.',
      },
      {
        title: 'Changelog',
        table: {
          headers: ['Data', 'Mudança'],
          rows: [
            ['Agosto de 2026', 'Publicação do plugin CoachPilot no diretório do ChatGPT, após aprovação para publicação pela OpenAI.'],
            ['Agosto de 2026', 'Servidor MCP em produção em mcp.coachpilot.com.br, com OAuth 2.1 e gestão de conexões no portal.'],
            ['Setembro de 2026', 'Documentação pública da integração (esta página) e alinhamento de terminologia ao Diretório de Plugins.'],
          ],
        },
      },
      {
        title: 'Referências',
        list: [
          '[Apps e plugins no ChatGPT — central de ajuda da OpenAI](https://help.openai.com/pt-br/articles/11487775).',
          '[Termos para desenvolvedores de apps da OpenAI](https://openai.com/pt-BR/policies/developer-apps-terms/).',
          'Documentação comercial: [ChatGPT para personal trainer](/chatgpt-para-personal-trainer).',
          'Artigo técnico: [app de personal trainer dentro do ChatGPT](/blog/app-de-personal-trainer-para-chatgpt).',
          'Instalação passo a passo: [como instalar o CoachPilot no ChatGPT](/blog/como-instalar-coachpilot-no-chatgpt).',
        ],
      },
    ],
    faqs: [
      { q: 'O CoachPilot é um plugin ou um app do ChatGPT?', a: 'É um plugin publicado no Diretório de Plugins do ChatGPT, e esse plugin inclui um app que conecta a conversa aos dados e ações autorizadas da conta CoachPilot. Em julho de 2026 a OpenAI migrou o diretório de apps para o Diretório de Plugins, empacotando os apps existentes em plugins — por isso os dois termos aparecem.' },
      { q: 'A publicação no diretório é um selo de segurança da OpenAI?', a: 'Não. A publicação significa que a identidade do plugin, o fluxo de login e o escopo de permissões foram declarados e revisados antes de o plugin ficar público. Os termos da OpenAI para desenvolvedores mantêm a responsabilidade pelo aplicativo com quem o publica. As garantias técnicas que valem são as listadas nesta página.' },
      { q: 'A IA consegue excluir alunos ou mexer na cobrança?', a: 'Não, com nenhuma permissão. Excluir aluno, apagar histórico e alterar plano, assinatura ou cobrança não existem como operação da integração.' },
      { q: 'Por quanto tempo dá para desfazer uma alteração feita pela IA?', a: 'Sete dias, pelo portal ou pedindo na própria conversa. Cada alteração gera um snapshot antes da gravação e uma notificação no portal com o resumo do que mudou.' },
      { q: 'A integração funciona com Claude e Gemini?', a: 'Sim. O protocolo é o MCP, padrão aberto: o endereço da conexão fica em Configurações → Conexões. No Claude, o conector personalizado funciona até no plano grátis, limitado a um; no Gemini, o caminho suportado hoje é CLI ou Vertex.' },
      { q: 'Quanto custa a integração?', a: 'Nada. Está incluída nos dois planos do CoachPilot, inclusive no gratuito de até 3 alunos. O custo de IA é o da assinatura do provedor escolhido e não passa pelo CoachPilot — e o Diretório de Plugins do ChatGPT está disponível também na conta gratuita.' },
    ],
    related: ['chatgpt-personal-trainer', 'ia-personal-trainer', 'termos', 'privacidade'],
  },
  ...
  'gestao-alunos': {
    ...
    faqs: [
      ...
      { q: 'Consigo consultar a carteira sem abrir o sistema?', a: 'Sim, conectando o ChatGPT, o Claude ou o Gemini por MCP: você pergunta quem está parado, quem está sem treino vigente ou quem tem mensalidade em atraso e recebe a resposta no chat.' },
    ],
  ...
  faq: {
    ...
    faqs: [
      ...
      { q: 'O CoachPilot tem plugin do ChatGPT?', a: 'Sim. O CoachPilot é um app publicado no diretório do ChatGPT: abra Plugins, busque por "coachpilot", clique no + e autorize com a sua conta. A mesma conexão funciona no Claude e no Gemini.' },
      { q: 'Como conecto minha IA ao CoachPilot?', a: 'No ChatGPT, instalando o app pelo diretório (Plugins → buscar "coachpilot" → +). No Claude ou no Gemini, copiando o endereço em Configurações → Conexões e adicionando no assistente. Na autorização você escolhe entre somente leitura ou leitura e escrita de treinos.' },
      { q: 'A IA conectada pode apagar meus dados?', a: 'Não. Não existe operação para excluir aluno, apagar histórico ou alterar plano, assinatura e cobranças. A escrita se limita a programas de treino, com notificação no portal e desfazer por 7 dias.' },
  ...
  termos: {
    ...
    sections: [
      ...
      { title: '10. Conexão com assistentes de IA externos', body: 'O personal pode conectar sua conta a assistentes de IA de terceiros (como ChatGPT, Claude ou Gemini) pela conexão MCP do CoachPilot. A conexão é opcional, exige autorização explícita no portal, alcança apenas os dados da própria conta e pode ser revogada a qualquer momento em Configurações → Conexões. Ao conectar, o personal autoriza o envio ao provedor escolhido dos dados que consultar pelo assistente — incluindo dados de saúde de seus alunos, como anamnese, avaliações físicas e relatos de dor —, que passam a ser tratados também sob os termos daquele provedor, em servidores no exterior. Por envolver dado sensível, cabe ao personal, antes de consultar essas informações pelo assistente, certificar-se de que o consentimento obtido do aluno abrange essa transferência; a consulta já alcança anamnese e avaliações, de modo que quem não deseja essa transmissão não deve conectar um assistente externo. O CoachPilot registra as alterações feitas por essa via, notifica o personal a cada escrita e permite desfazer alterações de treino por 7 dias; a prescrição resultante permanece sob a responsabilidade técnica do personal.' },
  ...
  privacidade: {
    ...
    sections: [
      ...
      { title: '9. Conexão com assistentes de IA externos', body: 'O personal pode conectar sua conta a assistentes de IA de terceiros (ChatGPT/OpenAI, Claude/Anthropic, Gemini/Google) pela conexão MCP do CoachPilot. A conexão é opcional, exige autorização explícita no portal e dá acesso apenas aos dados da conta daquele personal — nunca aos de outras contas. Com a conexão ativa, os dados que o personal consultar pelo assistente são transmitidos ao provedor escolhido para gerar a resposta, o que inclui dados pessoais sensíveis de saúde dos alunos (anamnese, avaliações físicas e relatos de dor) quando o personal os solicita. Esses provedores estão sediados fora do Brasil, o que caracteriza transferência internacional de dados nos termos dos arts. 33 e seguintes da LGPD, e o tratamento passa a se reger também pela política daquele provedor. No momento da autorização o personal escolhe conceder apenas leitura ou também escrita de treinos, e pode revogar a conexão a qualquer momento em Configurações → Conexões, com efeito imediato. Note que a consulta já abrange anamnese e avaliações: por isso, antes de consultar dados de saúde por um assistente externo, o personal deve verificar se o consentimento obtido do aluno cobre essa transferência, e quem não deseja essa transmissão simplesmente não deve conectar. Não há envio por iniciativa do CoachPilot: a transmissão só ocorre quando o personal faz uma consulta no assistente com a conexão ativa. Toda escrita por essa via fica registrada e é notificada ao personal.' },
      ...
      { title: '11. Retenção e exclusão', body: 'Os dados são mantidos enquanto a conta estiver ativa. Ao excluir um aluno ou encerrar a conta, os dados correspondentes — inclusive anamnese, avaliações, fotos de evolução e relatos de dor — são removidos dos sistemas ativos em prazo razoável, ressalvadas obrigações legais de guarda (como registros fiscais de pagamento). Itens temporários, como sessões de login e autorizações de conexão, expiram automaticamente. Cópias de segurança seguem o ciclo de retenção da infraestrutura e são descartadas ao fim dele.' },

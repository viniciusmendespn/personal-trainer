...
import { useDivAuthContext } from '../DivulgadorApp'

export function DivLoginPage() {
  const { user, loading, signIn } = useDivAuthContext()
        ...
        <form onSubmit={handle} className="space-y-4">
          <div className="text-center mb-2">
            ...
            <p className="text-sm text-text-secondary">
              Entre com sua conta CoachPilot para acompanhar suas comissões
            </p>
          </div>
